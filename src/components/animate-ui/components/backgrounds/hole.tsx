  ...
  return (
    <div
      ...
      className={cn(
        ...
        'after:content-[""] after:absolute after:z-[5] after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,#4a7a00_20%,transparent_75%)] after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-overlay',
        className,
      )}
      {...props}
    >
      ...
      <motion.div
        className={cn(
          ...
          'dark:[background:linear-gradient(20deg,#D5FF40,#6BBF0020_16.5%,#3a5e00_33%,#3a5e0020_49.5%,#D5FF40_66%,#D5FF4060_85.5%,#6BBF00_100%)_0_100%_/_100%_200%] [background:linear-gradient(20deg,#D5FF40,#6BBF0040_16.5%,#3a5e00_33%,#3a5e0040_49.5%,#D5FF40_66%,#D5FF4080_85.5%,#6BBF00_100%)_0_100%_/_100%_200%]',
        )}
